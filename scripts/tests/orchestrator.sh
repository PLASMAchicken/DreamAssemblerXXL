...
export SERVER_READY_FLAG SERVER_EXIT_FLAG CLIENT_LOADED_FLAG CLIENT_JOINED_FLAG CLIENT_SINGLEP_FLAG DUAL_EXIT_FLAG

CLIENT_GATE_SERVERLOADED="${CLIENT_GATE_SERVERLOADED:?CLIENT_GATE_SERVERLOADED HeadlessNH server gate must be set}"
export CLIENT_GATE_SERVERLOADED
